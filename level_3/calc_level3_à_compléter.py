...
for bouton in Boutons:
	button = Label(main_window, text = str(________________), height=4, width=5, bg="#211180", fg="#ffffff", borderwidth="1", relief="raised")
		
	button.grid(row=__________, column=______________)
	if bouton == "C":
		button.bind("<Button-1>", lambda e: ____________())
	else:
